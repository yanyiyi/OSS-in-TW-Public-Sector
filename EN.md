...
- Chapter 1: Introduction to Open-Source Software
  - 1.1 How it started
  - 1.2 International Trends and Applications
  - 1.3 Basic Concept and Licensing Agreement Types of Open-Source Software
  - 1.4 Open-Source Software and Public Code
- Chapter 2: Open-Source Software Application Evaluation
  - 2.1 Difference Between Using Open-Source and Proprietary Software
  - 2.2 Open-Source Software Benefits and Risks Analysis
  - 2.3 Open-Source Software Implementation Model
  - 2.4 Open-Source Software Governance System
- Chapter 3: Open-Source Software Implementation
  - 3.1 Software Development Process: Needs and Cautions when Designing Open-Source Software
  - 3.2 Software Development Process: Considerations for Open Source During Development and Testing
  - 3.3 Software Development Process: Open-Source Considerations for Go-Live and Acceptance
  - 3.4 Releasing Development Outcomes as Open Source
- Chapter 4: Open-Source Software Maintenance and Operations
  - 4.1 Open-Source Software Operations and Maintenance
...
In an era where information technologies are flourishing, where the competition of big data and artificial intelligence applications has never been higher and where the control mechanisms for information security and risk management are being significantly strengthened, the operational needs and requirements for information system development and maintenance at government agencies have continued to rise, with the goal to enhance the administrative and operational efficiency within agencies while providing the public with more convenient digital services. However, the government’s information agencies commonly are understaffed with stagnant technological innovation. Against this backdrop, t### 4.3 Conclusion

The adoption of open-source software and public code offers new possibilities and opportunities for change.
Open-source software is a development and licensing model in contrast to proprietary software. When discussing software system procurement, what people are typically accustomed to is seeking products or tools in the market that already provide the needed core functionalities based on business requirements, and then requesting vendors to provide and help install a customized version of the said software. This is usually paired with pricing models such as buy-out, licensing, or
...
subscription agreements, allowing the agency to obtain the “right to use” the system after it goes live. The above illustrates how “proprietary
software” operates. After proprietary software goes online, agencies typically continue relying on the original vendor for maintenance services, resulting in a relatively higher cost for switching in the future. The above illustrates how “proprietary software” operates. After proprietary software goes online, agencies typically continue relying on the original vendor for maintenance services, resulting in a relatively higher cost for switching in the future.
On the other hand, the core feature of open-source software is that its source code is publicly available and allows others to use, copy, modify, distribute, and share the technology. Procurement of open-source software systems focuses on establishing collaborative relationships among developers, vendors, and communities. When introducing such systems, agencies gain access to technical support, integration services, and long-term maintenance capabilities. Under this model, not only can agencies truly obtain “ownership” of the system, but they can also reduce licensing costs, avoid vendor lock-in, enhance technical autonomy and flexibility, and accelerate innovation and problem-solving capabilities by leveraging global community resources and the open-source ecosystem.

At the same time, Public Code echoes the spirit behind the promotion of open-source software, which began in Europe and has since expanded and flourished in advanced countries such as the United States and Canada. Public Code is based on the principle of “public money, public code,” encouraging the public sector to release source code—developed or procured using public budgets—under open-source licenses. It can be thought of as “the public sector’s open-source software repository.” The Public Code released by government agencies can not only be effectively utilized by other agencies with similar needs—thereby reducing the manpower, budget, and services.
This is especially important when services involve public interests, as transparent Public Code enables the public to understand how systems operate, fostering trust, enhancing civic participation, and strengthening the nation’s digital infrastructure.
Therefore, the Ministry of Digital Affairs has prepared this manual, expecting the concise explanations in the manual will help agencies understand open-source software and Public Code. It aims to assist information-planning personnel in gradually establishing and formulating appropriate information-management measures and standards for open-source software and enable information officers, IT developers, and maintenance crew to understand how to adopt open-source software. In doing so, agencies can align with international digital-development trends and gradually promote the widespread application of open-source software.

Therefore, the Ministry of Digital Affairs has prepared this manual, expecting the concise explanations in the manual will help agencies understand open-source software and Public Code. It aims to assist information-planning personnel in gradually establishing and formulating appropriate information-management measures and standards for open-source software and enable information officers, IT developers, and maintenance crew to understand how to adopt open-source software. In doing so, agencies can align with international digital-development trends and gradually promote the widespread application of open-source software.

![Preface illustration](assets/from-pptx/en/ppt/media/image6.png)
...
Richard Stallman1：Founder of the Free Software Foundation. He also launched the GNU Project and the Free Software Foundation, which later brought tremendous changes to the computer world.
GNU2 ：A recursive acronym for “GNU is Not Unix”. A recursive acronym, is one that refers to itself, creating a humorous, self-referential loop, a tradition started among hackers in the early days, especially at MIT.
...
Open-sourced software (OSS) originated from Eric Raymond3’ essay “The Cathedral and the Bazaar4” in 1997. This essay discussed the two development models: The Cathedral Model and the Bazaar Model and Eric Raymond believed that the Bazaar Model will result in better development quality since “given enough eyeballs, all bus are shallow.”
The Cathedral Model
The Bazaar Model
...
![Cathedral model illustration](assets/from-pptx/en/ppt/media/image8.png)

![Bazaar model illustration](assets/from-pptx/en/ppt/media/image7.jpeg)
...
This essay was also responsible for inspiring Netscape’s decision to release its “Netscape Communicator” as free software in 1998, which was developed via public collaboration. Netscape Communicator eventually evolved into popular software such as Mozilla Firefox and Thunderbird5. As Netscape announced to make its browser’s source code open source, a group of community leaders began to discuss how to make it easier for the business community to accept this software model and introduce the concept and benefits of free software by Free Software Foundation to the commercial software industry. Thanks to the rapid development of the Linux operating system and the Internet in the 90s, many software projects thrived with public collaboration.
Eric Raymond3 ： Generally recognized as one of the main leaders for the open-source movement since 1997. He is also one of the founders of the Open-Source Initiative.
The Cathedral and the Bazaar4: These are two different development models for free software. Under the Cathedral Model, the software is managed and monitored by a dedicated team. Under the Bazaar Model, the software is made public during its development, allowing public collaboration for fast correction and rapid releases.
Mozilla Firefox and Thunderbird 5 ：Mozilla’s two main open-source projects. Firefox is a web browser that evolved from Netscape; Thunderbird is an email application, which also supports personal information management (such as “Contacts”).
...
Open-Source Definition, OSD6 ：https://opensource.org/osd
...
In cloud services, Docker has already become an indispensable deployment tool. Its Docker Engine8 is a well-known open-source software project licensed under the Apache License 2.0. The core of cloud system management, Kubernetes9, is also under the same license and has been widely supported by major cloud service providers such as AWS, GCP, and Azure.
Finally, the foundation of AI computing services—deep-learning frameworks such as PyTorch10 and TensorFlow11 as well as tools used for training and research, such as NumPy12—are all widely used open-source projects. These examples fully demonstrate that modern digital development is fundamentally built upon free and open-source software.

Docker Engine8 ：https://docs.docker.com/engine/#licensing
Kubernetes9：https://kubernetes.io/
PyTorch10 ：https://en.wikipedia.org/wiki/PyTorch
Tensorflow11 ：https://github.com/tensorflow/
NumPy12 ：https://en.wikipedia.org/wiki/NumPy

### 1.2 International Trends and Applications

This section includes 3 examples of government agencies adopting open-source software in other countries, which will help us understand the main trend of the adoption of open-source software among government agencies.

#### 1.2.1 German Federal Government Led the Development of openDesk

![openDesk feature overview](assets/from-pptx/en/ppt/media/image9.png)
...
officework and collaborative platform consisting of multiple free and open-source software. Designed for public and administrative agencies, openDesk’s functions include word processing, spreadsheet, email, calendar, contacts, cloud storage, instant messaging, conference calls, project management module and Wiki13. Initially, openDesk was developed under the Soverign Workplace Project led by Bundesministerium des Innern (BMI). In early 2024, ZenDis took the reins for the further development and management of openDesk. openDesk was not developed from scratch. Instead, it integrates many mature open-source software from businesses and the public sector and provides a consistent user interface and experience. This allows fast deployment, keeps the maintenance cost in check and reduces duplicate development and waste in resources.
...
Wiki13 ：A website that allows multiple parties to edit and maintain. Its greatest feature is “collaboration and real-time updates”- meaning that any authorized user can add, edit or delete content on the page without needing any programing knowledge.
...
Policy and legal support: The promotion of openDesk echoes with the German government’s digital strategy, IT-Planungsrat14 and “Digital Sovereignty” policy, which encourage government agencies to adopt open-source software to ensure their autonomy and flexibility.
IT-Planungsrat14 ：Founded jointly by Germany’s federal government and its federal states with the goal to coordinate the collaboration between the Federal Republic and federal states on IT and e-Government.

#### 1.2.2 UN Proposes “Digital Public Goods”
...
#### 1.2.3 The US’ Federal Source Code Policy
...
The GNU General Public License (GPL) is the strictest copyleft15 license with the strongest protection. However, after years of evolution, 3 GPL variants appeared in response to the different computer and Internet environment. They are: AGPL (the strongest), GPL (the standard) and LGPL (the weaker license).
...
#### 1.3.2 Mozilla Public License（MPL） v2
...
Copyleft15：A license that protects users’ rights to use the software freely utilizing the current copyright system. Copyleft software licenses are considered protective or reciprocal (in contrast with permissive free software licenses)
...
But licensed works, their modified versions, and larger works containing them can all be released under different licenses without the requirement to publish the source code. It can be said that Apache License has “no copyleft concept at all.” Users may freely modify, redistribute, and even integrate Apache-licensed source code into proprietary software without having to release the modified or complete project source code. Its goal is to maximize adoption, enabling anyone (including private businesses) to use it freely. For example: Hadoop16, Spark17 and Kubernetes18—large-scale infrastructure software—almost all use Apache v2 because it allows enterprises to adopt and invest resources in their projects confidently.
Hadoop16：A distributed storage and processing framework, designed specifically for batch processing of large-scale datasets.
Spark17：A fast and disputed computing engine that support ram computing, suitable for big data analysis and real-time processing
Kubernetes18：An open-source development platform for containers for automating deployment, scaling, and management of containerized applications.

#### 1.3.4 MIT License

MIT is a short and simple permissive license agreement. Its only term is that the copyright notice and permission notice must be included. Under this condition, licensed works, modified versions of source code and larger project containing such works can be published under different licenses without making public the source code. The MIT License is used comprehensively (including Node.js19 and Ruby on Rails20).

#### 1.3.5 Boost Software License 1.0

Boost Software License 1.0 is a simple and permissive license, similar to MIT but even more permissive. Its only term is that the copyright notice and license text must be included when distributing the source code (does not apply to the edited binary file). Covered works, modified version of the software (including larger project containing such works) can be published under different licenses without publishing the source code. Boost Software License 1.0 is commonly used in the C++ community, mainly the Boost Library21.
...
Node.js 19 ：A JavaScript runtime environment, suitable for processing high-concurrency and asynchronous I/O.
Ruby on Rails20：A web application framework written in the Ruby programming language, designed for rapid development with “convention over configuration”.
Boost 21：A set of high-performance and cross-platform C++ libraries that provides data structures, algorithms and supports new tools. expansion.
...
Mission
Target
Open-source Software and Public Cod
...
| --- | --- | --- |
| System Integration | Usually adopts the open standard with higher system integration flexibilitynd customization depends on the product’s API or protocol | Usually adopts the open standard with higher system integration flexibility. |
...
When the public sector uses open-source software for information system development, it is not only a practice of open and transparent digital governance, but also delivers significant benefits in terms of cost, security, customization and system-integration capability, vendor flexibility and policy value.”

Policy and Public Value

For the public sector, going open source is not only a technical choice but also a policy statement—one that emphasizes digital tools serving the public interest, enhances system transparency and auditability and strengthens public trust.
Highly-Predictable Financial Cost

The adoption of open-source software means low initial cost since there is no licensing fee. This means the agency will have fair bargaining power over future maintenance fees.

The adoption of open-source software means no vendor lock-in. Agencies may freely choose to work with local or international providers, reducing the risk of vendor lock-in, promoting industry development, and flexibly procuring high-quality and cost-effective services.

開源軟體使用效益
Open-source Software Benefits

Autonomy in Security Management
High System Integrability
Open-source software mostly adopts a standard protocol and format and thus is easy to be incorporated into the existing system and support cross-platform collaboration
Publicly available source code helps the public sector maintain control over systems and strengthen information security. Communities and third parties can identify and fix vulnerabilities earlier, improving protection and risk-management.

Highly Customizable
Open-source software can be freely modified. Government agencies can, based on their business processes, adjust the functions, expand the modules and optimize the interface of the software to build a system that truly meets their needs and thus enhance their efficiency and service quality.
High Flexibility in
Vendor Choice

#### 2.2.2 Risk Analysis of Open-Source Software

Even though the adoption of open-source software offers significant benefits, a complete risk assessment is still required during the information system implementation process, focusing on its selection items. The risk-assessment process can be integrated with the agency’s existing risk-management activities, including: (1) collecting potential risk issues associated with the software that the agency is currently using or planning on using; (2) evaluating each issue’s risks based on the likelihood and impact; and (3) formulating response measures for risk issues whose scores exceed acceptable thresholds. Below are five common risks when using open-source software:

Transition Risk

System transitions inevitably involve the commitment of resources. Although open-source software has no licensing fees, migrating from an existing proprietary system to open-source software may still require substantial manpower and time. Data migration, process redesign, system verification and employee training are all hidden costs that cannot be ignored.
Vendor Quality and Maintenance Responsibility
Commercial software often comes with clear service contracts and technical support while open-source projects rely on community support. Given the highly responsibility-oriented nature of public administration, lacking a reliable development and maintenance team may lead to risks that affect actual operations. Vendor selection for

open-source software is highly flexible and in cases where an information system integrates multiple open-source software, several vendors may share maintenance responsibilities. If working with low-quality vendors, system-development quality may become unstable, maintenance efficiency may decline, and technical gaps or communication difficulties may arise during the project, affecting overall progress and outcomes.
Information Security Risk
Information security is a critical issue in system operations. Open-source software often requires pairing with security-monitoring mechanisms to identify and patch vulnerabilities in real time. Although popular open-source projects generally have fast vulnerability-fix cycles, agencies that fail to establish monitoring mechanisms or collaborate with third-party vendors for regular testing and updates may leave their systems exposed to known vulnerabilities. All software systems require regular maintenance for potential vulnerabilities. The advantage of open-source software is that its source code is mostly public and jointly reviewed by communities, allowing issues to be identified and resolved more transparently and thus lowering the possibility that a vendor may withhold disclosure of security risks. In addition, a 2022 report by U.S. software firm Red Hat22 indicated that as many as 89% of IT leaders consider open-source software to be as secure as proprietary software.
Red Hat （2022） 22：https://www.redhat.com/en/enterprise-open-source-report/2022

Licensing and Legal Risk
Although open-source software does not require licensing fees, its license terms (such as GPL, MIT, Apache, etc.) are legally binding and users must comply with the relevant requirements. If licensing-compatibility issues are not handled properly during secondary development or system integration, infringement risks may arise. For example, the GPL license requires that derivative works must also adopt the same license; failure to adequately separate proprietary modules may result in a violation of licensing terms. Therefore, agencies should establish a licensing-review mechanism and consult legal advisors to ensure compliance.
Use Acceptance
Civil servants are generally accustomed to proprietary tools such as Microsoft Office or Google Workspace. Even if OpenDesk—as mentioned in Section 1.2.2 of this manual—already provides complete functionality, differences in user experience may affect willingness to adopt it. Thus, training and cultural transformation are key.
...
When the public sector uses open-source software for information system development, it is not only a practice of open and transparent digital governance, but also delivers significant benefits in terms of cost, security, customization and system-integration capability, vendor selection flexibility, and policy value.
1. Adopt
When project requirements can be clearly mapped to mature open-source software to quickly address an agency’s immediate needs, the “adopt” model is an efficient and relatively low-risk approach. Its advantages mainly include the following:
Reducing implementation time and duplicate development.
Sharing global community experience, operational outcomes and security updates.
Adopting open specifications and standards for higher system scalability.
With publicly available source code and community resources, reducing maintenance challenges.

2. Integrate
The “integrate” model formulates flexible solutions tailored to local needs by combining multiple open-source projects (such as frameworks, libraries and data platforms) and has become the mainstream model among European governments. For example, Germany’s openDesk integrates a variety of existing open-source services to create a sovereign office suite designed for German public agencies. This enables the public sector to independently operate its collaborative office environment, strengthens national data sovereignty and system autonomy and avoids constraints imposed by cross-border network environments and proprietary commercial software.
3. Self-built
In scenarios involving special requirements or critical applications (Critical or Sovereign Systems)—for example, when existing open-source projects cannot meet domestic legal requirements, specific administrative processes or cultural and language needs—it may be necessary to consider building systems in-house to ensure legal compatibility and long-term maintenance flexibility. Likewise, for projects involving national security, digital sovereignty or core government services (such as internal identity and personal-data management, AI models, or cybersecurity infrastructure), it is essential to ensure that the technology stack is controlled domestically, avoiding dependence on a single foreign supplier. In such cases, self-built solutions may be considered as the core of the project.

Regardless of which of the above strategies you choose, the key to successful open-source adoption lies in an “Open First” approach. From the outset, openness should be treated as a design principle, with projects assuming future open-sourcing at an early stage and preparing accordingly in system architecture, license management and documentation. Only when necessary—for reasons such as security, privacy, or unpublished policies—should certain components remain closed. In other words, openness is the norm and closure is an evaluated exception. Through clear layering and modular design, governments can effectively protect sensitive information while still releasing source code openly. For details on layered design, reference may be made to the UK government guideline “Security Considerations When Coding in the Open”23, which reminds us that “security should be designed into openness, not into secrecy.”
Separation of key and certificate
Use a secure key management system and forbit hardcoding the certificate in the source code

Open
「Security should be designed into openness, not into secrecy.」
《Security Considerations When Coding in the Open》
Automated scanning and reviewing
Incorporate the automated tool in version control to detect potential and sensitive data
Responsible vulnerability reporting mechanism
Build an open, transparent and safe reporting mechanism for vulnerabilities
All security mechanisms should be executed first, helping to progressively strengthen security governance at different stages and form a dense and openness-centered safety net.
The UK Government guideline ‘When Code Should Be Open or Closed”23: Guidance issued by the UK Government Digital Service that explains the position that public authorities should prioritize releasing code as open source when using or developing software, while also outlining the reasons why code must remain closed in certain circumstances.”

#### 2.3.2 Explore Projects and Referenceable Platform
...
| --- | --- | --- | --- |
| Software Index
openCode.de | The Centre for Digital Sovereignty (ZenDis) of Germany | Focuses on digital sovereignty and compliance in the EU, with an emphasis on reusability and continued maintenance | OpenDesk (refer to 1.2.2 of this Manual) FIM (Federated Information Management) Smart Village App (a local governance application). |
| SILL database
...
When evaluating whether to adopt an existing open-source project, agencies are advised to focus on actual needs, development capacity and governance requirements as the core criteria, rather than relying solely on regional or language differences. After forking, many open-source projects can often meet local requirements through integration and customization while retaining the operational strength of their global communities. For example, Germany’s OpenDesk, based on Nextcloud24, was re-integrated into a version that complies with German public-administration security and privacy regulations. Such reuse is not merely a technical extension but also a governance strategy: while maintaining a shared code base, institutional management ensures continued access to community support and maintenance. Similarly, OS2 borgerPC (Citizen PC Workstation), launched by Denmark’s OS2 Alliance25 (Offentligt Software Samarbejde), was localized and renamed Medborgare (meaning “citizen”) when adopted in Sweden. While the original OS2 architecture and maintenance processes were preserved, a Sweden-specific localization model was also developed.
Nextcloud24: An open-source cloud storage and collaboration platform similar to Google Drive or Microsoft OneDrive
OS2 Alliance 25: Offentligt Digitaliseringsfæ llesskab, an open-source community jointly maintained by the public sector and IT vendors in Denmark that believes that “public code owned by the public sector with vendor choice.” OS2 also develops and maintains the government’s IT solutions
...
#### 2.4.1 Open-Source Software Governance System
...
#### 2.4.2 Open-Source Software Policy and Software Bill of Materials
...
#### 2.4.3 Introduction to International Open-Source Compliance Standards
...
Ihe requirements of ISO/IEC 18974 correspond structurally to those of ISO/IEC 5230, together forming a comprehensive governance framework. Its key practice areas, mapped to the software development lifecycle as described in the table below:
...
When designing the next-generation healthcare IT infrastructure, NHS Digital27 of the United Kingdom,did not build a massive monolithic system. Instead, it established a set of open API standards that allow
NHS Digital 27: NHS Digital established a centralized API management platform and adopted open standards to lower the barriers for third-party service integration, enabling diverse services to continuously expand on a shared modular API architecture and forming a healthy and competitive digital ecosystem. Source: How NHS Digital used API Management to support APIs at scale.

different service providers to connect in a modular manner, promoting market competition and innovation.
3. nventory potential open-source software and search for suitable projects
...
![X-Road architecture diagram](assets/from-pptx/en/ppt/media/image27.png)
...
#### 3.2.1 Upstream First: Avoid “Fork Fatigue”
...
#### 3.2.2 Version Control and Automated Integration
...
#### 3.3.1 Open-Source Software License Compliance Review (Checklist) and Risk Management Recommendations

For open-source software adopted within a project, it is recommended to use the “License Compliance Assessment Checklist for Public-Sector Use of Open-Source Software (or Public Code)” as the review tool (please refer to Appendix V, “License Compliance Assessment Checklist for Public-Sector Use of Open-Source Software (or Public Code)” and

Appendix VI, “License Compliance Assessment Checklist Sample” of this manual). The checklist primarily includes three sections: basic project information, review items and development outcomes as public code. It assists agencies in identifying risks associated with the use of open-source software and in planning appropriate risk-mitigation measures. Based on the results of completing the assessment checklist, agencies should pay particular attention to the following items in order to strengthen the quality of risk management when using open-source software.
...
#### 3.3.2 The core of acceptance: Transferability, Readability and Sustainability
...
#### 3.3.3 Aligning with International Standards: Assessing Project Completion Using the Public Code Standard Framework

To make acceptance criteria more objective and internationally aligned, project managers may map the various deliverables described above to the specific provisions of the Standard for Public Code28 (SfPC). SfPC is a quality framework for open-source projects designed specifically for the public sector, with the goal of ensuring that Public Code is reusable, sustainable and capable of collaboration. Aligning acceptance items with SfPC not only enables a systematic evaluation of a project’s open-source maturity, but also demonstrates to domestic and international communities that the project adheres to global best practices.
Public Code Standard28: A quality framework for open-source projects designed for the public sector. The Chinese version is available at: https://pdis.github.io/publiccodenet.standard/
...
#### 3.4.1 Key Governance Considerations for Public Code
...
![Public code maintenance tier diagram](assets/from-pptx/en/ppt/media/image28.png)
...
#### 3.4.2 Establishing Clear and Friendly Community Contribution Processes
...
#### 3.4.3 Active community support and engagement
...
![Grafana monitoring dashboard screenshot](assets/from-pptx/en/ppt/media/image29.png)
...
#### 4.1.7 Documentation Management
...
![Documentation management and delivery matrix](assets/from-pptx/en/ppt/media/image30.png)
...
#### 4.2.1 Open-Source talent development and culture building
...
#### 4.2.2 Community Activity Monitoring and Continuous Integration
...
#### 4.2.3 Establishing System Management and Upgrade Strategies
...
#### 4.2.4 License Management and Code Reuse
...
#### 4.2.5 Connecting Communities and Public Code Platforms
